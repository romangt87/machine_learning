...
pred_final = predict(modelFit6, newdata=plm_testing)
pred_final
...
modelFit6_final = train(classe ~ ., method="nb", data=training4_final)
pred_final_v2 = predict(modelFit6_final, newdata=plm_testing)
